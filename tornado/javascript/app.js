(function() {
    ...
    App.controller('dataBeaconController', function($http, $window) {
        ...
        beacon.search = function() {
            ...
            $http.get('query', { 'params': { 'chrom': beacon.chromosome, 'pos': beacon.position - 1, 'alternateBases': beacon.alternateBases, 'referenceBases': beacon.referenceBases, 'dataset': beacon.dataset, 'ref': beacon.reference}})
