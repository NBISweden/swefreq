    ...
    def __init__(self, settings):
        self.declared_handlers = [
            ...
            (r'/(favicon.ico)',                                                      tornado.web.StaticFileHandler,
                                                                                         {"path": "static/img/"}),
            (r"/release/(?P<dataset>[^\/]+)/(?P<hash>[^\/]+)/(?P<file>[^\/]+)",      handlers.EphemeralStaticNginxFileHandler,
                                                                                         {"path": "/release-files/"}),
            ...
            ("/api/datasets/(?P<dataset>[^\/]+)/ephemeral_link",                     application.GenerateEphemeralLink),
            ...
            ("/api/datasets/(?P<dataset>[^\/]+)/versions/(?P<version>[^\/]+)/ephemeral_link", application.GenerateEphemeralLink),
            ### Beacon API
