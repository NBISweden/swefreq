    ...
    def __init__(self, settings):
        self.declared_handlers = [
            ...
            (r"/release/(?P<dataset>[^\/]+)/(?P<hash_value>[^\/]+)/(?P<file>[^\/]+)",handlers.TemporaryStaticNginxFileHandler,
                                                                                         {"path": "/release-files/"}),
            (r"/release/(?P<dataset>[^\/]+)/(?:version/(?P<ds_version>[^/]+)/)?(?P<file>[^\/]+)", handlers.AuthorizedStaticNginxFileHandler,
                                                                                         {"path": "/release-files/"}),
            ## Authentication
            ...
            (r"/api/dataset/(?P<dataset>[^\/]+)/(?:version/(?P<ds_version>[^/]+)/)?files", application.DatasetFiles),
            ...
            (r"/api/dataset/(?P<dataset>[^\/]+)/(?:version/(?P<ds_version>[^/]+)/)?temporary_link", application.GenerateTemporaryLink),
